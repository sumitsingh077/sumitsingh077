...
I'm **Sumit Kumar**, an undergraduate **Computer Science student at Sharda University**, passionate about building technology-driven solutions and exploring modern software development.
...
| | |
|---|---|
| 🎓 **Education** | B.Tech Computer Science — Sharda University |
| 💻 **Languages** | C, C++, Python |
| 🌐 **Development** | HTML, CSS, JavaScript |
| 🤖 **Interests** | AI & Emerging Technologies |
| 🥽 **Exploring** | AR / VR |
...
An immersive **Virtual Reality Aquarium Experience** designed to create an interactive virtual environment.

**Technologies / Focus**

`Virtual Reality` `3D Environment` `Immersive Experience`

---

### 🤖 Robot AR

An **Augmented Reality project** focused on creating an interactive AR-based experience.

**Technologies / Focus**

`Augmented Reality` `Interactive Experience` `AR`

---

### 💻 C Programming

A collection of **C programming concepts and problem-solving programs** created while strengthening programming fundamentals.
...
<img src="https://raw.githubusercontent.com/sumitsingh077/sumitsingh077/output/github-contribution-grid-snake-dark.svg" alt="GitHub Contribution Snake"/>
